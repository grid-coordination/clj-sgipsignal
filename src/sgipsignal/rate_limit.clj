(ns sgipsignal.rate-limit
  "Sliding-window rate limiter for SGIP Signal API requests.

  The SGIP Signal API allows 10 requests per second. This namespace provides
